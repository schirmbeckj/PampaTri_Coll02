...
var regions = ee.FeatureCollection('projects/MapBiomas_Pampa/ANCILLARY_DATA/Zonas_Pampa_ARG_buffer10km_Zona4manual_Marbuff300')

var limite = regions.geometry()
var biome = 'PAMPAARGENTINA'
var pts = ee.FeatureCollection('projects/MapBiomas_Pampa/SAMPLES/C2/ARGENTINA/samples_C2_PAMPAARGENTINA_' + versao)
...
//for (var i_ano=0;i_ano<1; i_ano++){
  ...
  //print('ano',ano)
    var mosaicoTotal = mosaicos.filterMetadata('year', 'equals', (ano))
                        .mosaic()
    if (ano == 2000){//usa o valor do ano como apmlitude
    ...
    if (ano == 2001){//usa os 2 anos anteriores como amplitude
      //var amp3anos = max3anos.subtract(min3anos).rename('amp_ndvi_3anos')
...
Export.table.toDrive({
    ...
    description: 'pontos_exp1_' + versao + '_' + ano + '_shp'
    })
*/
