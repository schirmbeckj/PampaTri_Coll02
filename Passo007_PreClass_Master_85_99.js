...
var id_zona ="graben_LM"  // Identificador de Zona. Siempre entre comillas
...
var year_inicio = 1985 //Año en el cual se desea comenzar a clasificar
var year_fin = 1999 // Año en el cual se desea terminar de clasificar
...
if (bioma == "PAMPAARGENTINA" ) {
  ...
  var dirsamples = "projects/MapBiomas_Pampa/SAMPLES/C2/ARGENTINA/YEARF/"
...
if (bioma == "PAMPAURUGUAY" ) {
  //De donde salen las muestras
  var dirsamples = "projects/MapBiomas_Pampa/SAMPLES/C2/URUGUAY/YEARF2/"
...
var balanced = ee.FeatureCollection(dirsamples + 'datos-uru-analisis-1-'+ year +'-m3').filterMetadata('Muestras3', "equals",  1)
